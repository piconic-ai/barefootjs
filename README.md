...
|----------|---------|--------|---------|
| TypeScript | [Hono](docs/core/adapters/hono-adapter.md) — Hono / JSX-based servers | .tsx | `@barefootjs/hono` |
| Go | [Go](docs/core/adapters/go-template-adapter.md) — html/template (Echo, Gin, Chi, net/http) | .tmpl + _types.go | `@barefootjs/go-template` |
| Perl | [Perl](docs/core/adapters/perl-adapter.md) — Mojolicious, Text::Xslate (any PSGI/Plack app) | .ep / .tx | `@barefootjs/mojolicious`, `@barefootjs/xslate` |
| Ruby | [Ruby](docs/core/adapters/ruby-adapter.md) — stdlib ERB (any Rack app — Sinatra, Rails) | .erb | `@barefootjs/erb` |
| Python | [Python](docs/core/adapters/python-adapter.md) — Jinja2 (Flask, Django, bare WSGI) | .jinja | `@barefootjs/jinja` |
| PHP | [PHP](docs/core/adapters/php-adapter.md) — Twig (Slim, plain PHP), Laravel Blade (illuminate/view standalone) | .twig / .blade.php | `@barefootjs/twig`, `@barefootjs/blade` |
| Rust | [Rust](docs/core/adapters/rust-adapter.md) — minijinja (axum, actix-web, warp) | .j2 | `@barefootjs/rust` |
| — | [CSR](docs/core/adapters/csr.md) — None (browser-only) | — (client-rendered) | `@barefootjs/client` |
<!-- ADAPTER-TABLE:END -->
