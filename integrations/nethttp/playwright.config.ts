...
export default defineConfig({
  ...
  webServer: {
    ...
    // this suite) already wrote the matching `bf_assets_prod.go`.
    command: 'BASE_PATH=/integrations/nethttp PORT=8083 go run -tags production .',
    url: 'http://localhost:8083/integrations/nethttp',
