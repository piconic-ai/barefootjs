...
export default defineConfig({
  ...
  plugins: barefoot({
    ...
    // recursively, and `mux.Handle("GET "+basePath+"/static/", ...)`
    // already serves everything under `dist/` (including `dist/templates`,
    // same as before this migration — not a new exposure this PR
    // introduces).
