#!/usr/bin/env sh
# Static build for hosting under a path (e.g. barefootjs.dev/slides/overview/).
...
# inject once, right after <head>; give the page its real title (peitho writes "Peitho Deck")
sed -i.bak 's#<head>#<head>\n  <script type="module" src="assets/deck.js"></script>#; s#<title>Peitho Deck</title>#<title>BarefootJS Overview</title>#' "$OUT/index.html"
