...
export const renderDivergences: RenderDivergences = {
  ...
  // in PHP/Blade template scope. The `fmt(label)` slot renders silently
  // empty instead of computing the real value or refusing to compile.
  // Verified directly against real PHP Blade (after `composer install
  // --working-dir packages/adapter-blade/php`) in the #2994
  // investigation.
  ...
  // above — same #2994 root cause (no `fmt` binding in PHP/Blade template
