...
export const renderDivergences: RenderDivergences = {
  ...
  // in PHP/Twig template scope. The `fmt(label)` slot renders silently
  // empty instead of computing the real value or refusing to compile.
  // Verified directly against real PHP Twig (after `composer install
  // --working-dir packages/adapter-twig/php`) in the #2994
  // investigation.
