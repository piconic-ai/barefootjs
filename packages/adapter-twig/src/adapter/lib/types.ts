/**
 * Shared type aliases for the Twig template adapter.
 *
...
/**
 * Twig adapter's IRNode render context. Like the Jinja adapter, Twig's
 ...
 */
export type TwigRenderCtx = Record<string, never>

export interface TwigAdapterOptions {
