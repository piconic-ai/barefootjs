...
export interface TwigEmitContext {
   ...
   * metadata at init. Read by `TwigTopLevelEmitter`'s `lowering` seam (#2843)
   ...
   * (`convertExpressionToTwig`) is asked to lower directly.
   */
   ...
   * Twig template lowering, unlike a genuine signal/memo getter. See
