...
- 70a4923: Mark a region swap in flight with `data-bf-navigating`

  A swap commits the incoming markup and only _then_ re-hydrates it — and
...
- 08d74c1: Reconcile `<head>` page metadata across a soft navigation
