 ...
 * and no unused-import failure mode to guard against either. So this
 * composition's core job is just what core's `barefoot()` already does:
 * construct `MojoAdapter` and hand it to core.
 *
...
/**
 * Options of `@barefootjs/mojolicious/vite`'s `barefoot()`.
 *
 * @since 0.31.0
 * @stability alpha
 */
