...
export default defineLimitation({
  ...
  actual: 'emits the slot as a bare template-variable lookup named after the const, with no diagnostic, so the backend renders an empty slot or fails on the unbound name',
