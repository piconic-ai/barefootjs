    ...
    createEffect(() => {
      if (__ra_s2) {
        ...
        if (!(0 in __l) || !Object.is(__l[0], __x)) {
          ...
          if ('value' in __ra_s2) { if (__ra_s2.value !== __val) { __ra_s2.value = __val; if (__ra_s2.tagName === 'SELECT' && !__ra_s2.multiple && __ra_s2.value !== __val) __ra_s2.selectedIndex = 0 } } else { __ra_s2.setAttribute('value', __val) }
        }
        __l[0] = __x }
      }
    })
