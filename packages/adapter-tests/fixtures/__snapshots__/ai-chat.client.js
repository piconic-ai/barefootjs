  ...
  createEffect(() => {
    if (_s6) {
      ...
      if (!(0 in __l) || !Object.is(__l[0], __x)) {
        ...
        if ('value' in _s6) { if (_s6.value !== __val) { _s6.value = __val; if (_s6.tagName === 'SELECT' && !_s6.multiple && _s6.size <= 1 && _s6.value !== __val) _s6.selectedIndex = 0 } } else { _s6.setAttribute('value', __val) }
      }
      __l[0] = __x }
