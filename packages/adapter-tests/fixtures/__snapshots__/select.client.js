...
hydrate('SelectValue', { init: initSelectValue, template: (_p) => `<span data-slot="select-value" ${(_p.id) != null ? 'id="' + escapeAttr(_p.id) + '"' : ''} class="pointer-events-none truncate" bf="s1"><!--bf:s0-->${escapeTextOrMarkup(_p.placeholder ?? '')}<!--/--></span>` })
