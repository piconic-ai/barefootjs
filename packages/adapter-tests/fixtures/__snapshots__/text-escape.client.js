...
hydrate('TextEscape', { init: initTextEscape, template: (_p) => `<div class="text-escape"><p class="label" bf="s1"><!--bf:s0-->${escapeTextOrMarkup(_p.label)}<!--/--></p><button type="button" bf="s3"> count: <!--bf:s2-->${escapeTextOrMarkup((0))}<!--/--></button></div>` })
