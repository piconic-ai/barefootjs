...
import { bfText, bfTextEnd, serializeHydrationProps } from '@barefootjs/hono/utils'
...
export function Tooltip(__allProps: TooltipProps & { __instanceId?: string; __bfScope?: string; __bfChild?: boolean; __bfNoSerialize?: boolean; __bfParentProps?: string; __bfParent?: string; __bfMount?: string; "data-key"?: string | number }) {
