...
hydrate('PaginationDynamicDemo', { init: initPaginationDynamicDemo, template: (_p) => `<div class="space-y-4">${renderChild('Pagination', {children: `${renderChild('PaginationContent', {children: `${renderChild('PaginationItem', {children: `${renderChild('PaginationPrevious', {href: "#"}, undefined, 's0')}`}, undefined, 's1')}${renderChild('PaginationItem', {children: `${renderChild('PaginationLink', {href: "#", isActive: (1) === 1, children: ` 1 `}, undefined, 's2')}`}, undefined, 's3')}${renderChild('PaginationItem', {children: `${renderChild('PaginationLink', {href: "#", isActive: (1) === 2, children: ` 2 `}, undefined, 's4')}`}, undefined, 's5')}${renderChild('PaginationItem', {children: `${renderChild('PaginationLink', {href: "#", isActive: (1) === 3, children: ` 3 `}, undefined, 's6')}`}, undefined, 's7')}${renderChild('PaginationItem', {children: `${renderChild('PaginationLink', {href: "#", isActive: (1) === 4, children: ` 4 `}, undefined, 's8')}`}, undefined, 's9')}${renderChild('PaginationItem', {children: `${renderChild('PaginationLink', {href: "#", isActive: (1) === 5, children: ` 5 `}, undefined, 's10')}`}, undefined, 's11')}${renderChild('PaginationItem', {children: `${renderChild('PaginationNext', {href: "#"}, undefined, 's12')}`}, undefined, 's13')}`}, undefined, 's14')}`}, undefined, 's15')}<p class="text-center text-sm text-muted-foreground" bf="s17"> Page <!--bf:s16-->${escapeText((1))}<!--/--> of ${escapeText((5))}</p></div>` })
