...
export function initDropdownMenuContent(__scope, _p = {}) {
  ...
  const handleMount = (el) => {
    ...
    const updatePosition = () => {
      ...
      const { top, left } = clampDropdownMenuPosition(
        rect,
...
// ---- inlined ui/lib/clamp-dropdown-menu-position.ts ----
/**
 ...
 */
export function clampDropdownMenuPosition(triggerRect, contentSize, viewport, align, gap = 4) {
