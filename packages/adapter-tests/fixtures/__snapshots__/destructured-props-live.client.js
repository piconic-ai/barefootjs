...
export function initDestructuredPropsLive(__scope, _p = {}) {
  ...
  createEffect(() => {
    ...
    if (__LiveChild_s6El) {
      ...
      if (!(0 in __l) || !Object.is(__l[0], __x)) {
        if (__LiveChild_s6El.hasAttribute('label')) { const __v = __x; if (__v != null) __LiveChild_s6El.setAttribute('label', String(__v)); else __LiveChild_s6El.removeAttribute('label') }
      }
      __l[0] = __x }
    }
  }) }
