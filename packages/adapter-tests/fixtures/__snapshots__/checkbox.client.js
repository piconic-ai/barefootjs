import { $, $c, applyRestAttrs, createComponent, createEffect, createMemo, createSignal, escapeAttr, forwardProps, hydrate, initChild, insert, insertRoot, renderChild, spreadAttrs } from '@barefootjs/client/runtime'
