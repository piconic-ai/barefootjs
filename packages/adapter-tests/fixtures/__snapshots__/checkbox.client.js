...
export function initCheckIcon(__scope, _p = {}) {
  ...
  if (_s0) applyRestAttrs(_s0, _p, ["xmlns","viewBox","fill","stroke","stroke-width","stroke-linecap","stroke-linejoin","className","aria-hidden"])
...
export function initGitHubIcon(__scope, _p = {}) {
  ...
  if (_s0) applyRestAttrs(_s0, _p, ["xmlns","viewBox","fill","className","aria-hidden"])
...
export function initIcon(__scope, _p = {}) {
  ...
  if (_s1) applyRestAttrs(_s1, _p, ["xmlns","width","height","viewBox","fill","stroke","stroke-width","stroke-linecap","stroke-linejoin","className","aria-hidden"])
