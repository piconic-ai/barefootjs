import { $, $c, applyRestAttrs, createComponent, createEffect, createSignal, escapeAttr, escapeTextOrMarkup, escapeTextOrNode, forwardProps, hydrate, initChild, lazySlots, renderChild } from '@barefootjs/client/runtime'
