...
export const renderDivergences: RenderDivergences = {
  ...
  // in Perl/Text::Xslate template scope. The `fmt(label)` slot renders
  // silently empty instead of computing the real value or refusing to
  // compile. Verified directly against real Text::Xslate (after
  // installing the `Text::Xslate` CPAN module) in the #2994
  // investigation.
  ...
  // above — same #2994 root cause (no `fmt` binding in Perl/Text::Xslate
  // template scope), same silently-empty render. The doc comment above
  // already anticipated this shape ("arrow-valued const OR `function`
