...
export const renderDivergences: RenderDivergences = {
  ...
  // in Python template scope. The `fmt(label)` slot renders silently
  // empty instead of computing the real value or refusing to compile.
  // Verified directly against real Python `jinja2` in the #2994
  // investigation.
  ...
  // above — same #2994 root cause (no `fmt` binding in Python template
