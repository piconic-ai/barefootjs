...
export const renderDivergences: RenderDivergences = {
  ...
  // (an unrecognised name resolves as an undefined Jinja variable, and
  // `bf.truthy(undefined)` is falsy) instead of refusing loudly — a
  ...
  // shape-check method) needs net-new Jinja runtime helper code, tracked
  // at https://github.com/piconic-ai/barefootjs/issues/3012.
