...
export const conformancePins: ConformancePins = {
  ...
  // BF101 instead of Pebble silently iterating zero times.
  ...
  // evaluator-JSON `*_eval` mechanism (`pebble-adapter.ts`'s header,
  ...
  // pinned — unlike mojo (which refuses them), Pebble lowers them via the
