/**
 * Shared type aliases for the Pebble template adapter.
 *
...
/**
 * Pebble adapter's IRNode render context. Like the Xslate adapter, Pebble's
 ...
 */
export type PebbleRenderCtx = Record<string, never>
