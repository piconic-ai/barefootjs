...
4. Apply any fixes directly on the branch, re-run the relevant tests, commit them, and push — the NEXT PR in the stack depends on this being pushed before you move on. ${COMMIT_TRAILER_RULE}
